...
class Home extends React.Component {
    ...
    getcrewList2 = async () => {
        ...
        this.setState({ crews2: crew, isLoading: false })
    }
    ...
    render() {
        const { isLoading, crews, crews2, ads } = this.state;
        ...
        return (
            <div style={{ margin:"auto", width:"70%" }}>
                ...
                <div style={{ overflow: "auto", display: "flex" }}>{isLoading ? 'Loading' : crews2.map((crew) => {
                    return <Crew
                        key={crew.idcrew}
                        idcrew={crew.idcrew}
                        crewname={crew.crewname}
